...
export const seoGuidesBySlug: Record<string, SeoGuide> = {
  ...
  "power-factor-correction-calculator": {
    sections: [
      { title: "How to calculate power factor", paragraphs: ["Choose the pair of values available from a meter, nameplate, or load study. The calculator completes the power triangle and reports power factor, phase angle, real power, reactive power, apparent power, and line current."], steps: ["Select single-phase or three-phase AC.", "Choose the known-value combination.", "Enter two power quantities or the meter readings.", "Review PF and phase angle.", "Use correction mode only when a capacitor-bank estimate is required."] },
      { title: "Real, reactive, and apparent power", paragraphs: ["Real power P in kW performs useful work. Reactive power Q in kvar supports alternating electric and magnetic fields. Apparent power S in kVA is the RMS voltage-current loading seen by cables, transformers, and switchgear. These quantities satisfy S² = P² + Q² for the sinusoidal displacement-power model."], callouts: ["PF = P / S = cos φ", "S² = P² + Q²"] },
      { title: "Power factor calculation example", paragraphs: ["A load using 100 kW at 125 kVA has a power factor of 0.80. The corresponding reactive power is 75 kvar and the phase angle is approximately 36.87°. On a balanced 400 V three-phase supply, 125 kVA corresponds to approximately 180 A of line current."], callouts: ["PF = 100 kW / 125 kVA = 0.80", "Q = √(125² − 100²) = 75 kvar", "I = 125,000 / (√3 × 400) ≈ 180 A"] },
      { title: "Single-phase and three-phase line current", paragraphs: ["For single-phase AC, apparent power is voltage multiplied by current. For balanced three-phase AC, use line-to-line voltage and the √3 factor. Power factor is required when calculating current from real power, but not when apparent power in kVA is already known."], callouts: ["Single-phase: I = P / (V × PF)", "Three-phase: I = P / (√3 × VLL × PF)", "Three-phase from kVA: I = S × 1000 / (√3 × VLL)"] },
      ...
      { title: "Displacement power factor and true power factor", paragraphs: ["The simple relation PF = cos φ applies directly to sinusoidal voltage and current and describes displacement power factor. Nonlinear loads introduce distortion, so a meter may report a lower true power factor even when displacement power factor is high. Use measured kW and true RMS kVA when harmonics are significant."] },
      { title: "Harmonics and capacitor-bank design", paragraphs: ["VFDs, UPS systems, welders, rectifiers, and nonlinear loads can create harmonic resonance and excess capacitor current. Measure harmonic conditions and evaluate detuned reactors, filters, capacitor voltage margin, capacitor-duty contactors, discharge resistors, ventilation, and automatic controller settings."] }
    ]
  },
